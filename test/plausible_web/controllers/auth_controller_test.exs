defmodule PlausibleWeb.AuthControllerTest do
  ...
  describe "POST /2fa/setup/initiate" do
    ...
    test "initiates setup rendering QR and human friendly versions of secret", %{
      ...
      assert html =~ secret
      refute text(html) =~ "You've been redirected here because your team enforces 2FA."
    end
    ...
    test "shows additional notice when `force` parameter set", %{conn: conn} do
      ...
      assert html = html_response(conn, 200)
      assert text(html) =~ "You've been redirected here because your team enforces 2FA."
    end
